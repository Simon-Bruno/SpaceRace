...
const ABILITY_1 : String = "ability_1"
const ABILITY_2 : String = "ability_2"
...
@export var DEFAULT_OBJECT_KEY = InputEventKey.new()
@export var DEFAULT_USE_ITEM_KEY = InputEventKey.new()
@export var DEFAULT_ABILITY_1_KEY = InputEventKey.new()
@export var DEFAULT_ABILITY_2_KEY = InputEventKey.new()
...
var object_key = InputEventKey.new()
var use_item_key = InputEventKey.new()
var ability_1_key = InputEventKey.new()
var ability_2_key = InputEventKey.new()
